...
class DQNAgent:
    ...
    def compute_loss(self, batch):
        states, actions, rewards, _, _ = batch  # Ignora next_states e dones
        ...
        # Q-value stimato dalla rete per l'azione selezionata nello stato corrente
        curr_Q = self.model.forward(states).gather(1, actions.view(-1, 1))

        # Il target è semplicemente la reward immediata
        expected_Q = rewards.view(-1, 1)

        # Calcolo della loss tra Q stimato e reward reale
